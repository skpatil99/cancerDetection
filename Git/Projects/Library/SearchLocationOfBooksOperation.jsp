				...
				<img src="images/7.jpg" class="img-responsive"><br><br>
						...
						<%
							try{
								...
								String selectQuery="select books.BookId,books.Book_Name,books.Author,books.BookCount,location.Department,location.Column_No,location.Row_No from books inner join location on books.BookId=location.BookId where books.Book_Name='"+name+"' or books.Author='"+author+"' ";
