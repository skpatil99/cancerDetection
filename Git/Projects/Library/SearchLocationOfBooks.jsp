	...
	<div class="container">
			...
			<div class="col-md-5 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
				<div class="skill">
						...
						<form method="POST" name="form" action="SearchLocationOfBooksOperation.jsp">
						...
						<input type="button" value="Home" style="margin:30px 900px;padding:20px;" onclick="window.location.href='Home.html'">
