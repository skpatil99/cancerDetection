					...
					int flag=0;
						...
						try{ 
							...
							try{
							  ...
							  password1 = (String)request.getParameter("password");
						}
						catch(Exception e){
							...
							String Query="select Id,password from SRegistration";
							...
							while(rs1.next())
							{
								...
								if(Id==ID1 &&(PASSWORD.equals(password1)))
								{
										...
										<div id="breadcrumb">
											<div class="container">	
												<div class="breadcrumb">							
													...
													<li>Issued Books</li>
													<li class="list"><a href="login.html" >logout</a></li>	
													...
													<table class="myTable" border="1" >
														...
														<%
															try{
																...
																String selectQuery="select student.studentId,student.BookId,books.Book_Name,books.Author from student inner join books on student.BookId=books.BookId where student.studentId=(select Id from SRegistration where SRegistration.Id='"+ID+"' and SRegistration.password='"+password+"') ";
		...
		%>
						...
						<html>
									...
									<body>
										...
										<div class="aboutus">
										<div class="container">
												<h3>Student is not Registered</h3>
												<hr>
												<div class="col-md-7 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
													<img src="images/7.jpg" class="img-responsive"><br><br>
												...
												<div class="col-md-5 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
														<div class="skill">
															...
															<h1 id="heading" >Student is not Registered</h1>
