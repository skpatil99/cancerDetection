	...
	<div class="container">
			...
			<div class="col-md-5 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
				<div class="skill">
					...
					<form method="POST" name="form" action="UpdateOperation.jsp">

						<p>BookId:</p><input type="text" name="BookId" placeholder="BookId" ><br>

						<p>NewName:</p><input type="text" name="NewName" placeholder="NewName" ><br>
						<p>NewAuthor:</p><input type="text" name="NewAuthor"  placeholder="NewAuthor" ><br>
						<p>NewPublisher:</p><input type="text" name="NewPublisher" placeholder="NewPublisher"  ><br>
						<p>NewCount:</p><input type="text" name="NewCount" placeholder="NewCount"><br>


						<input type="submit" value="Update" onclick="window.location.href='administration.jsp'">
