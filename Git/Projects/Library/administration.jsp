...
<%
						...
						try{
							...
							Connection co=DriverManager.getConnection("jdbc:mysql://localhost:3306/library","root","poiuytrewq");
							String Query="select Id,password from AdminRegistration ";
							...
							while(rs1.next())
							{
								...
								if(Id==id && (PASSWORD.equals(password)))
								{
									flag=1;
		%>
											...
											<div id="breadcrumb">
												<div class="container">	
													<div class="breadcrumb">							
														...
														<li>Admin</li>
														<li class="list"><a href="loginAdmin.jsp" >logout</a></li>	
											...
											<div class="container">
													...
													<div class="col-md-7 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="300ms">
														...
														<div class="skill">
															...
															<div class="container">
															  <h2>Admin Rights</h2>
															  <button type="button" class="btn btn-info" onclick="window.location.href='ListOfBooks.jsp'" >List of Books</button><br>
															  <button type="button" class="btn btn-primary" onclick="window.location.href='insert.jsp'" >insert</button><br>
															  <button type="button" class="btn btn-danger" onclick="window.location.href='update.jsp'" >Update</button><br>
															  <button type="button" class="btn btn-warning"  onclick="window.location.href='delete.jsp'" >Delete</button><br>
															  <button type="button" class="btn btn-warning" onclick="window.location.href='BookIssue.jsp'" >BookIssue</button><br>
															  <button type="button" class="btn btn-danger"  onclick="window.location.href='BookReturn.jsp'" >BookReturn</button><br>
															  <button type="button" class="btn btn-primary" onclick="window.location.href='StudentRegistration.jsp'" >Student Registration</button><br>    
															  <button type="button" class="btn btn-info"  onclick="window.location.href='SearchLocationOfBooks.jsp'">Search Location of Books</button><br>  
															</div>
