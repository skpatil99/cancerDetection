...
<head>
    ...
    <title>UpdateSuccessfully</title>
			...
			<div class="col-md-5 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
				<div class="skill">
					...
					<%
						...
						String NewPublisher = (String)request.getParameter("NewPublisher");
						...
						String updateQuery= "update books set Book_Name='"+NewName+"',Author='"+NewAuthor+"',Publisher='"+NewPublisher+"',BookCount='"+NewCount+"' where BookId='"+BookId+"' ";
						PreparedStatement pstat = con.prepareStatement(updateQuery);
						pstat.executeUpdate();
						pstat.close();
					...
					%>
						...
						<form method="POST" name="form" action="Home.html">
