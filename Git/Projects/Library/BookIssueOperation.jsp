	...
	<div class="container">
			...
			<div class="col-md-5 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
				...
				<%
					...
					String selectQuery="select Id from SRegistration ";
					...
					while(rs.next()){
						...
						if(ID==studentid)
						{
							...
							String insertQuery= "insert into student values('"+studentid+"','"+BookId+"')";
							PreparedStatement pstat = con.prepareStatement(insertQuery);
							pstat.executeUpdate();
							pstat.close();
							
							String updateQuery= "update books set BookCount=BookCount-1 where BookId='"+BookId+"'";
				...
				%>          <h2>Student is not Registered</h2>
				<%			
				...
				<form method="POST" name="form" action="BookIssue.jsp">
