	...
	<div class="container">
			...
			<div class="col-md-5 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
				<div class="skill">
					...
					<form method="POST" name="form" action="DeleteOperation.jsp">

							<p>BookId:</p><input type="text" name="BookId" ><br><br>


							<input type="submit" value="Delete" onclick="window.location.href='administration.jsp'">
