	...
	<div class="container">
			...
			<div class="col-md-5 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
				<div class="skill">
					...
					<form method="POST" name="form" action="BookReturnOperation.jsp">

						<p>StudentId:</p><input type="text" placeholder="StudentId" name="studentid"><br>
						<p>BookId:</p><input type="text" placeholder="BookId" name="BookId"><br><br>


						<input type="submit" value="Submit" onclick="window.location.href=BookReturn.jsp">
