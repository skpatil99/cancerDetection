	...
	<div class="container">
			...
			<div class="col-md-5 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
				<div class="skill">
					...
					<form method="POST" name="form" action="InsertOperation.jsp">

						<p>BookId:</p><input type="text" placeholder="BookId" name="BookId"><br>
						<p>BookName:</p><input type="text" placeholder="Book Name" name="BookName"><br>
						<p>Author:</p><input type="text" placeholder="Author" name="Author"><br>
						<p>Publisher:</p><input type="text" placeholder="Publisher" name="Publisher"><br>
						<p>BookCount:</p><input type="text" placeholder="Count" name="count"><br>


						<input type="submit" value="Insert" onclick="window.location.href='administration.jsp'">
