			...
			<div class="col-md-5 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
				<div class="skill">
					...
					<form method="POST" action="SRegistration.jsp">
						...
						<p>Name:</p><input type="text" placeholder="Full Name" name="Name">
						<p>Student Id:</p><input type="text" placeholder="Student Id" name="Id">
						<p>Class:</p><input type="text" placeholder="Class" name="Class">
						<p>Address:</p><input type="text" placeholder="Address" name="Address">
						<p>Email Id:</p><input type="text" placeholder="Email Id" name="Email">
						<p>Password:</p><input type="password" placeholder="Password" name="password">

						<input type="submit" value="Registration" onclick="window.ocation.href='StudentRegistration.jsp'">
